...
interface linechartdepartmentAttributes {
  id:  number,
  division: string,
  department: string,
  january: number,
...
module.exports = (sequelize: any, DataTypes: any) => {
  class linechartdepartment extends Model <linechartdepartmentAttributes> 
  implements linechartdepartmentAttributes{
    id!:  number;
    division!: string;
    department!: string;
    january!: number;
